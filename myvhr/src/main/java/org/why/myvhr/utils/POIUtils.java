...
public class POIUtils {
    public static ResponseEntity<byte[]> employee2Excel(List<Employee> list) {
        ...
        //文档类别
        docInfo.setCategory("employee info");
        //文档管理员
        docInfo.setManager("why");
        //设置公司信息
        docInfo.setCompany("www.why.org");
        //4. 获取文档摘要信息
        SummaryInformation summInfo = workbook.getSummaryInformation();
        //文档标题
        summInfo.setTitle("employee_info");
        //文档作者
        summInfo.setAuthor("why");
        // 文档备注
        summInfo.setComments("provided by why");
        //5. 创建样式
        //创建标题行的样式
        ...
        try {
            headers.setContentDispositionFormData("attachment", new String("employee.xls".getBytes("UTF-8"), "ISO-8859-1"));
