<template>
    ...
    <div class="permissManaTool">
        <el-input size="small" placeholder="English name" v-model="role.name">
            <template slot="prepend">ROLE_</template>
        </el-input>
        <el-input size="small" placeholder="Chinese name" v-model="role.nameZh"
                ...
                <el-card class="box-card">
                    ...
                    <div>
                        ...
                        <div style="display: flex;justify-content: flex-end">
                            ...
                            <el-button type="primary" @click="doUpdate(r.id,index)">confirm</el-button>
                        </div>
                    </div>
                </el-card>
            </el-collapse-item>
...
<script>
    export default {
        ...
        methods: {
            deleteRole(role) {
                this.$confirm('this operation will permanently delete [' + role.nameZh + '] role', 'prompt', {
